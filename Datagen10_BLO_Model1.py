...
if blo == 1:
    [A_blo,B_blo,params_blo,hist_blo] = BLOfunc_save(t_val,x_train_new,u_train_new,net_params_blo,twostep=blo_twostep)

np.save('A_datagen10_blo_1',A_blo)
np.save('B_datagen10_blo_1',B_blo)

with open('params_datagen10_blo_1.pkl','wb') as fp:
    pickle.dump(params_blo,fp)

with open('hist_datagen10_blo_1.pkl','wb') as fp:
    pickle.dump(hist_blo,fp)
